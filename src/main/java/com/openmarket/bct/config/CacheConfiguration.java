package com.openmarket.bct.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.openmarket.bct.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.openmarket.bct.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
